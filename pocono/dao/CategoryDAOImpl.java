...
import com.niit.pocono.model.Category;
	...
	public class CategoryDAOImpl implements CategoryDAO {
		...
		public boolean delete(String id) {
			...
			try {
				sessionFactory.getCurrentSession().delete(categoryDAO);
			} catch (Exception e) {
				e.printStackTrace();
				return false;
			}
	...
	@Transactional
		public CategoryDAO get(String id) {
			...
			List<CategoryDAO> list = (List<CategoryDAO>) query.list();
	...
	@Transactional
		public List<CategoryDAO> list() {
			@SuppressWarnings("unchecked")
			List<CategoryDAO> list = (List<CategoryDAO>) sessionFactory.getCurrentSession().createCriteria(CategoryDAO.class)
